jQuery(document).ready(function ($) {
  ...
  jQuery(".wm-banner-one-nav").slick({
    ...
    vertical: true,
    prevArrow:
      "<span class='slick-arrow-left'><i class='wmicon-arrows'></i></span>",
    nextArrow:
      "<span class='slick-arrow-right'><i class='wmicon-arrows'></i></span>",
    centerMode: false,
    focusOnSelect: true,
    responsive: [
      {
  ...
  jQuery(".wm-event-latest-slider").slick({
    ...
    infinite: true,
    prevArrow:
      "<span class='slick-arrow slick-arrow-left'><i class='wmicon-arrows4'></i></span>",
    nextArrow:
      "<span class='slick-arrow slick-arrow-right'><i class='wmicon-arrows4'></i></span>",
    responsive: [
      {
        breakpoint: 1024,
        settings: {
  ...
  jQuery(".wm-service-slider").slick({
    ...
    infinite: true,
    prevArrow:
      "<span class='slick-arrow slick-arrow-left'><i class='wmicon-arrows3'></i></span>",
    nextArrow:
      "<span class='slick-arrow slick-arrow-right'><i class='wmicon-arrows3'></i></span>",
    fade: true,
    responsive: [
      {
        breakpoint: 1024,
  ...
  jQuery(".wm-recent-list-slider").slick({
    ...
    centerMode: true,
    prevArrow:
      "<span class='slick-arrow slick-arrow-left'><i class='wmicon-arrows2'></i></span>",
    nextArrow:
      "<span class='slick-arrow slick-arrow-right'><i class='wmicon-arrows2'></i></span>",
    responsive: [
      {
        breakpoint: 1024,
        settings: {
  ...
  jQuery(".wm-partners-slider-classic").slick({
    ...
    infinite: true,
    prevArrow:
      "<span class='slick-arrow slick-arrow-left'><i class='wmicon-arrows'></i></span>",
    nextArrow:
      "<span class='slick-arrow slick-arrow-right'><i class='wmicon-arrows'></i></span>",
    responsive: [
      {
        breakpoint: 1024,
        settings: {
  ...
  jQuery(function () {
    jQuery("#wm-incs").click(function () {
      jQuery(":text[name='qtys']").val(
        Number($(":text[name='qtys']").val()) + 1
      );
    });
  ...
  jQuery(function () {
    jQuery("#wm-incd").click(function () {
      jQuery(":text[name='qtyd']").val(
        Number($(":text[name='qtyd']").val()) + 1
      );
    });
    ...
    styles: [
      {
        ...
        elementType: "labels",
        stylers: [{ visibility: "simplified" }, { color: "#4e5256" }],
      },
      {
        featureType: "administrative",
        elementType: "labels.text.fill",
        stylers: [{ color: "#4e5256" }, { visibility: "simplified" }],
      },
      {
      ...
      },
      {
        featureType: "water",
        elementType: "all",
        stylers: [{ color: "#e5e8ed" }, { visibility: "on" }],
      },
    ],
  };
